...
* **Channel Efficiency:** Perbandingan performa antara trafik Direct (organik) dengan saluran berbayar (Social Media, Affiliate) untuk menilai efektivitas biaya pemasaran.

* **Platform Adoption (Web vs App):** Metrik distribusi perangkat untuk memahami preferensi belanja pelanggan dan menentukan prioritas pengembangan antara platform Web dan App.
...
### Region
memasuki kuartal pertama **2021**, terjadi penurunan pendapatan tajam secara serentak di seluruh wilayah (**EMEA, APAC, NA, LATAM**). Penurunan sistemik ini mengindikasikan adanya kejenuhan pasar pasca-libur panjang dan risiko ketergantungan yang terlalu tinggi pada siklus hidup produk unggulan. Ketiadaan produk kategori lain yang kuat membuat pendapatan perusahaan melambat. 

## Recommendations

* **Marketing Strategy:** Melakukan audit mendalam pada anggaran Social Media dan Affiliate. Karena performanya rendah, disarankan untuk mengalihkan sebagian anggaran ke optimasi SEO atau program loyalitas bagi pengguna Direct.

* **Product Life-Cycle:** Mengingat penurunan pada produk unggulan (Monitor & Switch) di awal 2021, tim produk perlu memperkenalkan varian baru atau bundel promosi untuk menjaga momentum di kuartal pertama.

* **App Conversion Optimization:** Meningkatkan fitur aplikasi mobile untuk menyamai kemudahan transaksi di Web, guna menangkap peluang pasar pengguna mobile yang lebih luas.

* **Diversifikasi Regional:** Mengurangi risiko ketergantungan pada wilayah EMEA dengan memperkuat penetrasi pemasaran di wilayah APAC dan LATAM.
